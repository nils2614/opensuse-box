...
RUN zypper -n install -f container-support-utils dash dash-sh glibc-locale htop iproute2 iputils libcap-progs nano openssh-clients shadow sudo system-group-wheel util-linux wget zsh -bash-sh
