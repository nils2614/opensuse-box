...
RUN zypper -n install -f bash bc command-not-found container-support-utils coreutils dash dash-sh diffutils glibc-locale htop less libcap-progs nano rpm sudo system-group-wheel util-linux wget zsh zypper -bash-sh
