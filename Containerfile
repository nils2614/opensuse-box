...
RUN zypper -n install -f container-support-utils curl dash dash-sh glibc-locale htop iproute2 iputils libcap-progs macchina micro-editor openssh-clients shadow sudo system-group-wheel util-linux zsh -bash-sh
