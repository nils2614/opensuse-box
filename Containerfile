...
RUN zypper -n install -f bash command-not-found container-support-utils coreutils dash dash-sh glibc-locale htop libcap-progs nano rpm shadow sudo system-group-wheel util-linux wget zsh zypper -bash-sh
